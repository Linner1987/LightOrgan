...
import com.apps.kruszyn.lightorganapp.AlbumArtCache;
import com.apps.kruszyn.lightorganapp.R;
import com.apps.kruszyn.lightorganapp.utils.LogHelper;
import com.apps.kruszyn.lightorganapp.utils.QueueHelper;
...
public class QueueManager {
    ...
    public void setQueueFromSearch(String query, Bundle extras) {
        setCurrentQueue(mResources.getString(R.string.search_queue_title),
                QueueHelper.getPlayingQueueFromSearch(query, mMusicProvider));
    }
    ...
    public void setQueueFromMusic(String mediaId) {
        ...
        //}
        if (!canReuseQueue) {
            String queueTitle = mResources.getString(R.string.browse_musics_by_genre_subtitle,mediaId);
