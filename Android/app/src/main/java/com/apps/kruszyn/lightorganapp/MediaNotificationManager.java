...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public static final String ACTION_PAUSE = "com.apps.kruszyn.lightorganapp.pause";
    public static final String ACTION_PLAY = "com.apps.kruszyn.lightorganapp.play";
    public static final String ACTION_PREV = "com.apps.kruszyn.lightorganapp.prev";
    public static final String ACTION_NEXT = "com.apps.kruszyn.lightorganapp.next";
