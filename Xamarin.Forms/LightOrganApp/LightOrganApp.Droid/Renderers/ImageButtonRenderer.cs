...
using LightOrganApp.Enums;
using LightOrganApp.Renderers;
using LightOrganApp.Droid.Extensions;
using Color = Xamarin.Forms.Color;
using View = Android.Views.View;
using LightOrganApp.Controls;

[assembly: ExportRenderer(typeof(ImageButton), typeof(ImageButtonRenderer))]
namespace LightOrganApp.Renderers
{
    /// <summary>
